...
import { deleteImage } from '@/actions/product/delete-product-image';
import { Category } from '@/app/interfaces/category-interface';
import { Product, ProductImage as ProductWithImage } from '@/app/interfaces/product-interface';
...
export const ProductForm = ({ product, categories }: Props) => {
  ...
  const onSizeChange = async (size: string) => {
    ...
    if (sizes.includes(size)) {
      setValue('sizes', [...sizes.filter((e) => e !== size)]);
    } else {
